...
DROP INDEX TERM_NAME_SEARCH;
CREATE INDEX TERM_NAME_SEARCH ON TERM (NAME(500), TYPE);
CREATE INDEX LINE ON LINE (NAME(500));

ALTER TABLE RECEIPT ADD COLUMN CATEGORY CHAR(1);
...
CREATE INDEX CLASSIFIER_TEXT ON CLASSIFIER (TEXT(500));
