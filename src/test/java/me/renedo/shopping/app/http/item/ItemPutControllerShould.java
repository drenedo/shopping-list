...
final class ItemPutControllerShould extends RequestTestCase {
    ...
    @Test
    public void create_bad_item() throws Exception {
        UUID uuid = UUID.randomUUID();
    ...
    @Test
    public void create_not_valid_uuid() throws Exception {
