...
class ReceiptRetrieverTest {
    ...
    void retrieve_detail() {
        ...
        List<Line> lines = List.of(new Line(UUID.randomUUID(), null, null, "some-name", new BigDecimal(12.3D), 1, LocalDateTime.now()));
        Receipt receipt = new Receipt(uuid, null, "some-text", new BigDecimal(12.3D), "some-site", lines, LocalDateTime.now());
